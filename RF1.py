...
# In[3]:
# Imputing data with each year's group mode.
...
rf = RandomForestRegressor(n_estimators=600, min_samples_split = 6, min_samples_leaf = 10, max_depth = 100, max_features= 'auto', random_state=42)
...
plt.title("Feature importances based on RF1", y = 1.03, size = 18)
