...
def xgboost_hyper_param2(learning_rate,
    ...
    clf2 = XGBRegressor(
        ...
        gamma=gamma)
    return np.mean(cross_val_score(clf2, X_train, Y_train, cv=5, scoring='mean_absolute_error'))
 
optimizer2 = BayesianOptimization( f=xgboost_hyper_param2, pbounds=pbounds2, random_state=1)
...
optimizer2.maximize(init_points=3, n_iter=7, acq='ei')
